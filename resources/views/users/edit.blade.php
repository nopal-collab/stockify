<x-app-layout>
    ...
    <x-slot name="header">
        <div>
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Edit User</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Perbarui data pengguna: <strong>{{ $user->name }}</strong></p>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl shadow-sm overflow-hidden">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 px-8 py-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white">Form Edit User</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Ubah informasi pengguna yang diperlukan</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="password" name="password"
                                   ...
                                   class="w-full rounded-2xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 px-4 py-3 text-gray-900 dark:text-white focus:border-blue-500 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 outline-none transition">
                            <p class="mt-1 text-xs text-gray-400">Biarkan kosong jika tidak ingin mengganti password.</p>
                        </div>
